      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 sm:p-10 rounded-2xl shadow-2xl">
        <div className="flex flex-col items-center">
          ...
          <p className="mt-2 text-sm text-gray-600 text-center">
            Sign in to manage your BDA pipelines
          </p>
        </div>
          ...
          <div className="rounded-md shadow-sm space-y-4">
            <div>
              ...
              <input
                ...
                autoComplete="email"
                required
                className="appearance-none relative block w-full px-3 py-2.5 border border-gray-300 placeholder-gray-400 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm transition-colors duration-200"
        ...
        <div className="text-center mt-4">
          <p className="text-sm text-gray-600">
            ...
            <Link to="/register" className="font-semibold text-indigo-600 hover:text-indigo-500 transition-colors duration-150">
              Register here
            </Link>
          </p>
        </div>
